<template>
	<gracePage  style="background-image:url(/static/img/login_bg.png);background-size:cover;">
		...
		<view slot="gFooter" class="footer grace-padding grace-flex grace-space-between" style="padding: 20rpx;">
			<button class="grace-button" style="width: 40%; height: 90rpx;" type="primary" plain="true" @click="toLogin">登录</button>
			...
			<view style="position:fixed; left:25rpx; bottom:40rpx; width:700rpx;">
				...
				<view class="grace-flex-center" style="margin-top: 15upx;">
					<text class="grace-gray">天津蚂蚁智慧包装科技</text>
				</view>
				<view class="grace-flex-center">
					<text class="grace-gray">TIANJIN ANT IPT CO.LTD</text>
				</view>
			</view>
		</view>
	</gracePage>
